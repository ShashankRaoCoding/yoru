...
func Main(args []string) {
	...
	fmt.Println("  sixel - Render images in SIXEL format and print tables")
	...
	fmt.Println("  print image      Render images to SIXEL")
	fmt.Println("  print table      Render tabular text to a pretty table")
	fmt.Println("\nSIXEL Examples:")
	fmt.Println("  yoru sixel compatible")
	fmt.Println("  cat image.png | yoru sixel print image -i png")
	fmt.Println("  cat image.jpg | yoru sixel print image -i jpeg 100 50")
	fmt.Println("  cat data.csv | yoru sixel print table -i csv")
}
